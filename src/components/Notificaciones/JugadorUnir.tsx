          ...
          return (
            <div key={n.notificationId}>
              ...
              <div>
                ...
                {playersPosition(n.playerPosition)} y obtuvo una calificacion de{" "}
                {n.playerQualification}
              </div>
              <div>
                Si queres tener mas informacion contactalo al: {n.playerCell}
              </div>
              <button onClick={() => handleAccept(n.notificationId)}>
                Aceptar invitacion
              </button>
              <button onClick={() => handleReject(n.notificationId)}>
                Rechazar invitacion
              </button>
            </div>
          );
